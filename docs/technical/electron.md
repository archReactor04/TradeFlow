...
This means the two versions maintain **separate databases**. Data created in the browser won't appear in the Electron app and vice versa. Use the [Export & Backup]({{ site.baseurl }}/guides/export-backup) feature to transfer data between them.
